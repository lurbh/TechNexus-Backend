...
exports.up = async function(db) {
  ...
  await db.insert('products', ['product_name', 'category_id', 'brand_id', 'description', 'price', 'quantity_available'], ['iPhone 12', 1, 1, 'Latest iPhone model', 999.99, 100]);
  await db.insert('products', ['product_name', 'category_id', 'brand_id', 'description', 'price', 'quantity_available'], ['Galaxy S21', 1, 2, 'Samsung flagship smartphone', 899.99, 120]);
  await db.insert('products', ['product_name', 'category_id', 'brand_id', 'description', 'price', 'quantity_available'], ['Sony WH-1000XM4', 3, 3, 'Noise-canceling headphones', 349.99, 150]);
  await db.insert('products', ['product_name', 'category_id', 'brand_id', 'description', 'price', 'quantity_available'], ['Xbox Series X', 4, 4, 'Next-gen gaming console', 499.99, 70]);
